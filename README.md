...
**ImpostorGame** is a locally hosted multiplayer party game inspired by the classic “Who’s the impostor?” concept — now brought to the web!  
It was built just for fun, but it’s fully functional and easy to run.
...
2. **Locate the built file** in the `target/` folder  
